...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	Если Копирование Тогда
		...
		Если Элемент.ТекущиеДанные.ЭтоГруппа Тогда
			ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ГруппаФайлов", ПараметрыФормы);
		Иначе
...
Процедура ЗагрузитьФайлы(Команда)
	...
	ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ФормаИмпортаФайлов", ПараметрыФормы);
КонецПроцедуры
...
Процедура ЗагрузитьПапку(Команда)
	...
	ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ФормаИмпортаПапки", ПараметрыФормы);
...
Процедура СохранитьПапку(Команда)
	...
	ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ФормаЭкспортаПапки", ПараметрыФормы);
...
Процедура ПеренестиВГруппу(Команда)
	Если Элементы.Список.ВыделенныеСтроки.Количество() > 0 Тогда
		...
		ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ВыборГруппы", ПараметрыОткрытия, ЭтотОбъект);
	КонецЕсли;
КонецПроцедуры
...
Процедура ЗакончитьРедактирование(Команда)
	...
	Если МассивФайлов.Количество() > 1 Тогда
		...
		ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ФормаЗавершениеРедактирования", ПараметрыФормы, ЭтотОбъект);
...
Процедура ОткрытьФормуФайла(Знач ПрисоединенныйФайл, СтандартнаяОбработка = Ложь, ДополнительныеПараметры = Неопределено, 
	...
	Иначе	
		...
		ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ПрисоединенныйФайл", ПараметрыФормы,, ПрисоединенныйФайл,,, ОписаниеОповещенияОЗакрытии);
	КонецЕсли;
...
Процедура ОткрытьКарточкуФайла()
	...
	Если ТекущиеДанные.ЭтоГруппа Тогда
		ОткрытьФорму("Обработка.ЖБИ_РаботаСФайлами.Форма.ГруппаФайлов", ПараметрыФормы);
	Иначе
		ОткрытьФормуФайла(ТекущиеДанные.Ссылка,, ПараметрыФормы);
	КонецЕсли;
